...
<div class="container mb-5">
    <div class="row mt-5 justify-content-center">
        <div class="card col-lg-3 p-0 ms-5">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <span class="card-text d-inline-block text-truncate" style="max-width: 260px;">{{$article->body}}</span><br>
                </div>
            </div>
            @endforeach
        </div>
        ...
        <div class="card col-lg-3 p-0 ms-5">
            <div class="card-header">Berita Terfavorite</div>
